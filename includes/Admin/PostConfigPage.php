...
class PostConfigPage
{
        ...
        register_setting(
            ...
            [
                ...
                'default' => [
                    ...
                    'post_category' => 0,
                    'ai_content_prompt' => "You are a passionate football blogger writing for fans who love deep match insights. Your goal is to create an engaging, narrative-driven preview that feels like a conversation with a knowledgeable friend at a sports bar.
    ...
    public function render_max_games_per_day_field(): void
    {
        ...
        echo '<input type="number" name="' . 'aisprtsw_post_settings' . '[max_games_per_day]" value="' . esc_attr($value) . '" />';
    }
    ...
    public function render_max_games_per_hour_field(): void
    {
        ...
        echo '<input type="number" name="' . 'aisprtsw_post_settings' . '[max_games_per_hour]" value="' . esc_attr($value) . '" />';
    }
    ...
    public function render_post_intervals_field(): void
    {
        ...
        echo '<input type="number" name="' . 'aisprtsw_post_settings' . '[post_intervals]" value="' . esc_attr($value) . '" min="1" max="30" />';
    ...
    public function render_post_author_field(): void
    {
        ...
        echo '<select name="' . 'aisprtsw_post_settings' . '[post_author]">';
    ...
    public function render_post_category_field(): void
    {
        ...
        echo '<select name="aisprtsw_post_settings[post_category]">';
    ...
    {
        $options = get_option('aisprtsw_post_settings');
        $value = $options['ai_content_prompt'] ??  '';

        echo '<textarea name="' . 'aisprtsw_post_settings' . '[ai_content_prompt]" rows="6" cols="80">' . esc_textarea($value) . '</textarea>';
    ...
    public function render_featured_image_upload_field(): void
    {
        ...
        echo '<input type="text" id="featured_image_url" name="' . 'aisprtsw_post_settings' . '[featured_image_url]" value="' . esc_attr($value) . '" />';
    ...
    public function render_dalle_image_generation_field(): void
    {
        ...
        echo '<label>';
        echo '<input type="checkbox" name="' . 'aisprtsw_post_settings' . '[dalle_image_generation]" value="1" ' . $checked . '/>';
